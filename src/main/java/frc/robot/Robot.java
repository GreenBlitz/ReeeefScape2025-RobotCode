...
public class Robot {
	...
	public Robot() {
		...
		limelightFour.setMT1StdDevsCalculation(
			LimelightStdDevCalculations.getMT1StdDevsCalculation(limelightFour, -0.02, new StandardDeviations2D(0.5), new StandardDeviations2D(0.05))
		);
		...
		limelightThreeGB.setMT1StdDevsCalculation(
			LimelightStdDevCalculations.getMT1StdDevsCalculation(limelightThreeGB, -0.02, new StandardDeviations2D(0.5), new StandardDeviations2D(0.05))
		);
