...
public enum ElevatorState {
	...
	FAST_LOW_SUPER_ALGAE_REMOVE(0.3, 4, 4),
	SLOW_LOW_SUPER_ALGAE_REMOVE(0.3, 2, 2),
	LOW_SUPER_ALGAE_REMOVE_SLOWING_POINT(0.6),
	FAST_HIGH_SUPER_ALGAE_REMOVE(0.585, 4, 4),
	SLOW_HIGH_SUPER_ALGAE_REMOVE(0.585, 2, 2),
