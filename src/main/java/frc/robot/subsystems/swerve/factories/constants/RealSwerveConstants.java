...
public class RealSwerveConstants {
	...
	public static final double VELOCITY_AT_12_VOLTS_METERS_PER_SECOND = 2;
	...
	public static final Rotation2d MAX_ROTATIONAL_VELOCITY_PER_SECOND = Rotation2d.fromRadians(4);
