...
public enum ArmState {
	...
	CLOSED_L1(Rotation2d.fromDegrees(70), Rotation2d.fromRotations(1), Rotation2d.fromRotations(0.65)),
	...
	PRE_L1(Rotation2d.fromDegrees(8.5)),
	L1(Rotation2d.fromDegrees(8.5)),
