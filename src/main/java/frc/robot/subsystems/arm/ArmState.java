...
public enum ArmState {
	...
	MID_WAY_CLOSE(Rotation2d.fromDegrees(130), Rotation2d.fromRotations(3), Rotation2d.fromRotations(2)),
	...
	PRE_L4(Rotation2d.fromDegrees(55), Rotation2d.fromRotations(4), Rotation2d.fromRotations(2)),
	L4(Rotation2d.fromDegrees(-25), Rotation2d.fromRotations(4), Rotation2d.fromRotations(2)),
