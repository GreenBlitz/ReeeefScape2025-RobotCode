...
public enum ArmState {
	...
	PRE_L4(Rotation2d.fromDegrees(81), Rotation2d.fromRotations(2), Rotation2d.fromRotations(1.5)),
	L4(Rotation2d.fromDegrees(-3), Rotation2d.fromRotations(2), Rotation2d.fromRotations(1.5)),
	LOW_ALGAE_REMOVE(Rotation2d.fromDegrees(-4)),
	HIGH_ALGAE_REMOVE(Rotation2d.fromDegrees(35)),
	HOLD_ALGAE(Rotation2d.fromDegrees(90.5), Rotation2d.fromRotations(2), Rotation2d.fromRotations(4)),
