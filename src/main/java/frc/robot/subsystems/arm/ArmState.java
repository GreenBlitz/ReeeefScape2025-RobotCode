...
public enum ArmState {
	...
	MID_WAY_CLOSE(Rotation2d.fromDegrees(90), Rotation2d.fromRotations(1.5), Rotation2d.fromRotations(1.5)),
	...
	PRE_L4(Rotation2d.fromDegrees(81), Rotation2d.fromRotations(1.5), Rotation2d.fromRotations(1.5)),
	L4(Rotation2d.fromDegrees(-3), Rotation2d.fromRotations(1.5), Rotation2d.fromRotations(1.5)),
	LOW_ALGAE_REMOVE(Rotation2d.fromDegrees(-4)),
	HIGH_ALGAE_REMOVE(Rotation2d.fromDegrees(35)),
	HOLD_ALGAE(Rotation2d.fromDegrees(90.5), Rotation2d.fromRotations(1.5), Rotation2d.fromRotations(1.5)),
	TRANSFER_ALGAE_FROM_INTAKE(Rotation2d.fromDegrees(220)),
	PRE_NET(Rotation2d.fromDegrees(70), Rotation2d.fromRotations(1.5), Rotation2d.fromRotations(1.5)),
	NET(Rotation2d.fromDegrees(70), Rotation2d.fromRotations(1.5), Rotation2d.fromRotations(1)),
	PROCESSOR_OUTTAKE(Rotation2d.fromDegrees(206), Rotation2d.fromRotations(1.5), Rotation2d.fromRotations(1.5)),
