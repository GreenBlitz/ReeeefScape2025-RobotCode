...
public enum ArmState {
	...
	MID_WAY_CLOSE(Rotation2d.fromDegrees(130), Rotation2d.fromRotations(3), Rotation2d.fromRotations(1.5)),
	...
	PRE_L4(Rotation2d.fromDegrees(55), Rotation2d.fromRotations(3), Rotation2d.fromRotations(1.8)),
