...
public enum ArmState {
	...
	TRANSFER_ALGAE_FROM_INTAKE(Rotation2d.fromDegrees(220), Rotation2d.fromRotations(2), Rotation2d.fromRotations(2)),
	SOFT_TRANSFER_ALGAE_FROM_INTAKE(Rotation2d.fromDegrees(220)),
