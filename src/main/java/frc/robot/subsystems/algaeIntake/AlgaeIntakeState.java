...
public enum AlgaeIntakeState {
	...
	PROCESSOR_SCORE_WITHOUT_RELEASE(PivotState.PROCESSOR_SCORE, RollersState.IDLE),
	PROCESSOR_SCORE_WITH_RELEASE(PivotState.PROCESSOR_SCORE, RollersState.OUTTAKE),
