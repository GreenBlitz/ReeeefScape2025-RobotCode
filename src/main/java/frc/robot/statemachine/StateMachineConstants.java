...
public class StateMachineConstants {
	...
	public static final Rotation2d ARM_POSITION_TO_SOFT_CLOSE = Rotation2d.fromDegrees(190);
	...
	public static final double ELEVATOR_POSITION_TO_SOFT_CLOSE_ARM = 0.4;
