...
public class StateMachineConstants {
	...
	public static final Rotation2d ARM_POSITION_TO_NEED_RELEASE = Rotation2d.fromDegrees(120 + ArmConstants.POSITION_OFFSET.getDegrees());
	...
	public static final Rotation2d LIFTER_POSITION_TO_RELEASE_ARM = Rotation2d.fromDegrees(10);
