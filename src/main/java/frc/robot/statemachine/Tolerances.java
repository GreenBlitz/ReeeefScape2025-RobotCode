...
public class Tolerances {
	...
	public static final Pose2d REEF_RELATIVE_SUPER_ALGAE_REMOVE_POSITION = new Pose2d(0.035, 0.025, Rotation2d.fromDegrees(1));
	public static final Pose2d REEF_RELATIVE_SUPER_ALGAE_REMOVE_DEADBANDS = new Pose2d(1, 1, Rotation2d.fromRadians(2));
