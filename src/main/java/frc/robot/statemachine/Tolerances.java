...
public class Tolerances {
	...
	public static final Pose2d PROCESSOR_SCORING_POSITION = new Pose2d(0.2, 0.2, Rotation2d.fromDegrees(3));
	public static final Pose2d PROCESSOR_SCORING_DEADBANDS = new Pose2d(0.5, 0.5, Rotation2d.fromRadians(2));
